...
> （即时开跳/三分钟出框/30 分钟上限/限时仅 1'/月度三榜/结果页先行·新纪录恭喜解耦/首页不播语音/★每 50/60 格刻度环/火柴人最新规格/命名 JumpRope Star）,
...
（强制终止,前 1 分钟语音预告）、**空轮保护**（0 下不落档直接回首页）、限时**仅 1'**（**60 格刻度环**，
...
🔧 接力项（框架已留位）：首页四卡横滑与二级页组（排行榜三榜·月度/打卡记录分页/**追加记录补记页(8-18 新增)**/
最佳战绩 6 维度/设置 5 行）、日卡渲染与**结果卡自动生成**及云相册上报、动作要领幻灯片、虚拟绳与逢十金光、BGM 合成与闪避、
