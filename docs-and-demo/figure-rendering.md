...
>
> **风格定稿(2026-08-18 评审会)**:采用**粗壮简化的奥林匹克风格**火柴人(参考魔镜产品的粗线条样例),匹配人体关键点实时渲染——即本档现行几何(躯干 40 / 臂 18 / 腿 20 粗圆头线)方向正确;由设计侧先输出初稿验证技术可行性,实现路径=关键点 + 线宽(蔡博牵头尝试,伪代码即 §4 几何表与 `skelFrame()`)。
